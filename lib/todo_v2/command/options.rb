...
module Options
  ...
  def self.create_command_parser
    OptionParser.new do |opt|
      sub_command_help = [
        {name: 'create -n name -c content', summary: 'Create Todo_v2 Task'},
        {name: 'update id -n name -c content -s status', summary: 'Update Todo_v2 Task'},
        {name: 'list -s status', summary: 'List Todo_v2 Tasks'},
        {name: 'delete id', summary: 'Delete Todo_v2 Task'}
      ]
